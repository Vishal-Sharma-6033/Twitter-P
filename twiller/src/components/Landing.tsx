      ...
      <div className="flex-1 lg:flex-1 flex flex-col justify-center px-8 lg:px-16 max-w-lg lg:max-w-2xl">
        ...
        <div className="space-y-12">
          <div>
            ...
            <h2 className="text-2xl lg:text-3xl font-bold mb-8">{t('Join today.')}</h2>
          </div>
          ...
          <div className="space-y-5">
            <p className="text-lg font-bold">{t('Already have an account?')}</p>
            <Button
              variant="outline"
            ...
            <Button asChild variant="ghost" className="w-full max-w-xs py-3 rounded-full text-white hover:bg-gray-900">
              <Link href="/subscription">{t('View subscription plans')}</Link>
            </Button>
